...
import { StaticWeapon } from "../types"

export default class Claw extends StaticWeapon {
    constructor(scene: PlayingScene, startingPosition: number[], dir: number[], damage: number, scale: number) {
        ...
        scene.weaponStatic!.add(this)
        // 공격 소리를 추가합니다.
        scene.sound.get('scratch').play({ volume: 0.5 })
